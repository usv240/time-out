...
table encounter {
  ...
  schema {
    ...
    json patient_flags
    bool practitioner_patient_relationship_established?=false
    bool adequate_medical_record_present?=false
    bool performer_identity_disclosed?=false
  ...
  index = [
    ...
    {type: "btree|unique", field: [{name: "public_id", op: "asc"}]}
